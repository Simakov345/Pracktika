...
void Book(string text)
{
    time_t now = time(0);
    char* dt = ctime(&now);
    ofstream Book("/home/stud/C++Projects/Education/lab2/book.txt", ios_base::app);
...
error1:
    ...
    cin >> U.Password;
    cin.ignore(numeric_limits<streamsize>::max(), '\n'); // Очистка буфера
    ifstream Data("/home/stud/C++Projects/Education/lab2/" + U.Login + ".txt");
    if (Data.is_open()) {
...
void CreatUser()
{
    ...
    ofstream Data("/home/stud/C++Projects/Education/lab2/" + Login + ".txt");
    Data << Password << endl;
    Data << "0";
    Data.close();
...
void DeleteUser()
{
    ...
    cout << "Введите логин пользователя: ";
    getline(cin, Login); // Ввод логина с использованием getline
    string path = "/home/stud/C++Projects/Education/lab2/" + Login + ".txt";
    ifstream Data(path);
    if (Data.is_open()) {
        Data.close();
        remove(path.c_str());
...
void Rights()
{
    ...
    string path = "/home/stud/C++Projects/Education/lab2/" + User + ".txt";
